...
public:
	...
	//下载图片并载入内存
	void downloadImageByHttp( const TCHAR* szUrl, const TCHAR* szName );
	void downloadImageByFtp( const TCHAR* szUrl, const TCHAR* szName, const TCHAR* pUser, const TCHAR* pPassword );
